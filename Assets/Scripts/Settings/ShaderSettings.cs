...
public class ShaderSettings
{
    ...
    public int seed;
    public ComputeShader shadingDataComputeShader;
    ...
    public Vector4[] GenerateShadingData(ComputeBuffer vertexBuffer)
    {
        ...
        if (shadingDataComputeShader)
        {
            // Set data
            SetShadingDataComputeProperties();

            shadingDataComputeShader.SetInt("numVertices", numVertices);
            shadingDataComputeShader.SetBuffer(0, "vertices", vertexBuffer);
            ComputeHelper.CreateAndSetBuffer<Vector4>(ref shadingBuffer, numVertices, shadingDataComputeShader, "shadingData");

            // Run
            ComputeHelper.Run(shadingDataComputeShader, numVertices);
    ...
    public void SetShadingDataComputeProperties()
    {
        ...
        detailNoise.SetComputeValues(shadingDataComputeShader, random, "_detail");
        detailWarpNoise.SetComputeValues(shadingDataComputeShader, random, "_detailWarp");
        largeNoise.SetComputeValues(shadingDataComputeShader, random, "_large");
        smallNoise.SetComputeValues(shadingDataComputeShader, random, "_small");
    }
