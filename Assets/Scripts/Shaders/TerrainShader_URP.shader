    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings IN) : SV_Target
            {
                ...
                float4 texNoise  = triplanar(IN.vertPosOS, IN.normalOS, _NoiseScale,  _NoiseTex);
                float4 texNoise2 = triplanar(IN.vertPosOS, IN.normalOS, _NoiseScale2, _NoiseTex);
